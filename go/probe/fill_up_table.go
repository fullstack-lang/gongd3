...
func fillUpTablePointerToGongstruct[T models.PointerToGongstruct](
	...
	case *models.Key:
		fillUpTable[models.Key](playground)
	case *models.Pie:
		fillUpTable[models.Pie](playground)
	case *models.Scatter:
		fillUpTable[models.Scatter](playground)
	case *models.Serie:
		fillUpTable[models.Serie](playground)
	case *models.Value:
		fillUpTable[models.Value](playground)
	default:
