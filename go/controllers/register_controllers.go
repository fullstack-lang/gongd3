...
func RegisterControllers(r *gin.Engine) {
	...
	{ // insertion point for registrations
		...
		v1.GET("/v1/hellos", GetHellos)
		v1.GET("/v1/hellos/:id", GetHello)
		v1.POST("/v1/hellos", PostHello)
		v1.PATCH("/v1/hellos/:id", UpdateHello)
		v1.PUT("/v1/hellos/:id", UpdateHello)
		v1.DELETE("/v1/hellos/:id", DeleteHello)
