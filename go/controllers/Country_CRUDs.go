...
func PostCountry(c *gin.Context) {
	...
	orm.BackRepo.BackRepoCountry.CheckoutPhaseOneInstance(&countryDB)
	country := (*orm.BackRepo.BackRepoCountry.Map_CountryDBID_CountryPtr)[countryDB.ID]

	if country != nil {
		models.AfterCreateFromFront(&models.Stage, country)
	}
...
func UpdateCountry(c *gin.Context) {
	...
	countryOld := (*orm.BackRepo.BackRepoCountry.Map_CountryDBID_CountryPtr)[countryDB.ID]
	if countryOld != nil {
		models.AfterUpdateFromFront(&models.Stage, countryOld, countryNew)
	}
...
func DeleteCountry(c *gin.Context) {
	...
	// get stage instance from DB instance, and call callback function
	countryStaged := (*orm.BackRepo.BackRepoCountry.Map_CountryDBID_CountryPtr)[countryDB.ID]
	if countryStaged != nil {
		models.AfterDeleteFromFront(&models.Stage, countryStaged, countryDeleted)
	}
