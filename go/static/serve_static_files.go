...
import (
	...
	"github.com/fullstack-lang/gongd3"
...
func ServeStaticFiles(logGINFlag bool) (r *gin.Engine) {
	...
	r.Use(static.Serve("/", EmbedFolder(gongd3.NgDistNg, "ng-github.com-fullstack-lang-gongd3/dist/ng-github.com-fullstack-lang-gongd3/browser")))
