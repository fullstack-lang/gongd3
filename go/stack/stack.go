...
import (
	...
	"github.com/fullstack-lang/gongd3/go/fullstack"
	"github.com/fullstack-lang/gongd3/go/models"
	"github.com/fullstack-lang/gongd3/go/orm"
	"github.com/fullstack-lang/gongd3/go/probe"
...
func NewStack(
	...
	if withProbe {
		stack.Probe = probe.NewProbe(r, gongd3_go.GoModelsDir, gongd3_go.GoDiagramsDir,
