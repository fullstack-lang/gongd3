...
export function CopyScatterDBToScatter(scatterDB: ScatterDB, scatter: Scatter, frontRepo: FrontRepo) {
	...
	// insertion point for pointer fields encoding
	scatter.X = frontRepo.Keys.get(scatterDB.ScatterPointersEncoding.XID.Int64)
	scatter.Y = frontRepo.Keys.get(scatterDB.ScatterPointersEncoding.YID.Int64)
	scatter.Text = frontRepo.Keys.get(scatterDB.ScatterPointersEncoding.TextID.Int64)
